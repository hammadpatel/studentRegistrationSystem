class SupportersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @supporter.save
        format.html { redirect_to acedemic_path, notice: 'Supporter was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @supporter.update(supporter_params)
        format.html { redirect_to acedemicrecords_url, notice: 'Supporter was successfully updated.' }
  ...
  private
    ...
    def supporter_params
      params.require(:supporter).permit(:supported_by, :supporters_firstname, :supporters_lastname, :relationship_with_applicant,
         :supporter_profession, :supporter_designation, :supporter_contactno, :supporter_email, :supporter_cnic, :organization_where_employed,
