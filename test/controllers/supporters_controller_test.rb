...
class SupportersControllerTest < ActionController::TestCase
  ...
  test "should create supporter" do
    assert_difference('Supporter.count') do
      post :create, supporter: { supported_by: @supporter.supported_by, supporters_firstname: @supporter.supporters_firstname }
    end
  ...
  test "should update supporter" do
    patch :update, id: @supporter, supporter: { supported_by: @supporter.supported_by, supporters_firstname: @supporter.supporters_firstname }
    assert_redirected_to supporter_path(assigns(:supporter))
  end
